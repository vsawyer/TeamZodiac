...
function Initialize() {
	...
	setUpWheels();
	//rigidbody.inertiaTensor = rigidbody.inertiaTensor + new Vector3(rigidbody.inertiaTensor.z * 100, 0, 0);
}
...
function checkSpaceBarInput() {
	if(Input.GetButtonDown("Jump")) {		
		...
		//if(Input.GetButtonDown("w")) {
			var crackerForce = Vector3(dir.x*100,3,dir.z*100);
			var crackerDir = Vector3.Normalize(crackerForce);
			var instanceCracker = Instantiate(firecrackers, frontCar.position, frontCar.rotation);
